    ...
    public void setBottomMenu() {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent playIntent = new Intent(SmashActivity.this, PlayActivity.class);
        ...
        mixup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mixIntent = new Intent(SmashActivity.this, MixActivity.class);
        ...
        radio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent radioIntent = new Intent(SmashActivity.this, RadioActivity.class);
        ...
        smash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent smashIntent = new Intent(SmashActivity.this, SmashActivity.class);
