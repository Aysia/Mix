    ...
    public void setBottomMenu() {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent playIntent = new Intent(MixActivity.this, PlayActivity.class);
        ...
        mixup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mixIntent = new Intent(MixActivity.this, MixActivity.class);
        ...
        radio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent radioIntent = new Intent(MixActivity.this, RadioActivity.class);
        ...
        smash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent smashIntent = new Intent(MixActivity.this, SmashActivity.class);
